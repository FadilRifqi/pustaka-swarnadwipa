...
# ... (Sisa fungsi start_attack, damage, die, animation tetap sama persis) ...
# (Copy paste bagian bawah dari kodemu yang lama, tidak ada perubahan di sana)
